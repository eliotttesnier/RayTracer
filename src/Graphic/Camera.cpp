...
RayTracer::Camera::Camera(const Math::Point3D &origin, const Rectangle3D &screen)
...
void RayTracer::Camera::rotateX(double degrees)
{
...
void RayTracer::Camera::rotateY(double degrees)
{
...
void RayTracer::Camera::rotateZ(double degrees)
{
...
void RayTracer::Camera::tilt(double degrees)
{
    rotateX(degrees);
}

void RayTracer::Camera::pan(double degrees)
{
    rotateY(degrees);
}

void RayTracer::Camera::roll(double degrees)
{
    rotateZ(degrees);
}

void RayTracer::Camera::setPosition(double x, double y, double z)
{
...
Math::Point3D RayTracer::Camera::getPosition() const
{
    return origin;
}

void RayTracer::Camera::setRotation(double x, double y, double z)
{
    Math::Point3D screenOrigin(0, 0, -1);
    Math::Vector3D bottom(1, 0, 0);
    Math::Vector3D left(0, 1, 0);
...
void RayTracer::Camera::updateTransformMatrix()
{
...
std::tuple<int, int> RayTracer::Camera::getResolution() const
{
    return resolution;
}

double RayTracer::Camera::getFov() const
{
    return fov;
}
