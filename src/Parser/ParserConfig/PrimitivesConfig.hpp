...
namespace Parser {
    ...
    class PrimitivesConfig {
        ...
        std::vector<std::pair<std::tuple<double, double, double, std::string>, std::tuple<int, int, int>>> _obj; // Position + filepath, Color
    public:
        ...
        std::vector<std::pair<std::tuple<double, double, double, std::string>, std::tuple<int, int, int>>> getOBJ() const;
